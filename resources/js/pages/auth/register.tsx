                            ...
                            {userType === 'restaurant' && (
                                <>
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        />
                                        <InputError
                                            message={errors.responsible_name}
                                        />
                                    </div>
                                    {/* fin nuevo campo */}
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        />
                                        <InputError
                                            message={errors.business_license}
                                        />
                                    </div>
                                    ...
                                    <div className="grid gap-2">
                                        <Label htmlFor="logo_url">
                                            URL del logotipo del restaurante
                                        </Label>
                                        <Input
                                            id="logo_url"
                                            type="text"
